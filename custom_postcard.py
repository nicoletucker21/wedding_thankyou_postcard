...
def create_custom_postcard():
    ...
    IMAGE = Image.open('/Users/nicoletucker/Dev/custom_postcard/back.png')

    # fonts
    SMALL_FONT = ImageFont.truetype('/Users/nicoletucker/Dev/custom_postcard/myFont.otf', 55)
    BIG_FONT = ImageFont.truetype('/Users/nicoletucker/Dev/custom_postcard/myFont.otf', 67)
    ITALIC_FONT = ImageFont.truetype('/Users/nicoletucker/Dev/custom_postcard/italic.ttf', 55)
    MESSAGE_SPACE = 15
    ADDRESS_SPACE = 69
    COLOR = (49, 128, 155)
